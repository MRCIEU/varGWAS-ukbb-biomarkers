...
env_exp <- c("smoking_status.20116.0.0","summed_MET_minutes_per_week_for_all_activity.22040.0.0","alcohol_intake_frequency.1558.0.0","estimated_fat_yesterday.100004.0.0","estimated_total_sugars_yesterday.100008.0.0","sex.31.0.0","age_at_recruitment.21022.0.0","body_mass_index.21001.0.0")
